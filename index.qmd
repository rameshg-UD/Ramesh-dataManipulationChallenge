...
### <font color="green">Ramesh Govindaswamy's Answers</font>

## Answer 1
```{python}
print ("Ans 1:")
col_dtype = shipments_df['actualShipDate'].dtype
print(f"\nData type of 'actualShipDate is': {col_dtype}")
```

## Answer 2
```{python}
print ("Ans 2:")
print ("Let's compare 04-11-2025 and 05-20-2024 as strings and dates:")
print ("\n*First we'll compare as strings")
print ("-"*50)
print(f"04-11-2025 > 05-20-2024 validates to: {'04-11-2025' > '05-20-2024'}")
print(">Though 04-11-2025 is greater than 05-20-2024, when compared as strings, it shows 05-20-2024 as the greater date.")
print ("\n*Now we'll compare as dates")
print ("-"*50)
print(f"04-11-2025 > 05-20-2024 validates to: {datetime.strptime('04-11-2025', '%m-%d-%Y') > datetime.strptime('05-20-2024', '%m-%d-%Y')}")
print("Validation is correct !!!")
print("This is why it is important to compare dates as dates, not as strings.")
...
print("The fix would be to use a map method in the lambda function as shown")
...
print("\nLate Shipments..")
print(shipments_with_lateness[shipments_with_lateness['is_late'] == True].head(5))

print("\nShipments on Time..")
print(shipments_with_lateness[shipments_with_lateness['is_late'] == False].head(5))
